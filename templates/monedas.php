    ...
    <div class="bg-white/10 p-8 rounded-xl shadow-lg backdrop-blur-md w-full max-w-md">
        <div class="flex justify-between items-start mb-6">
            <?php if (isset($_SESSION['usuario_id']) && $_SESSION['username'] === 'AstroOwn'): ?>
                <a href="index.php?page=admin_codes" class="bg-blue-500/20 border border-blue-400 text-blue-300 font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline transition duration-300 ease-in-out hover:scale-105">
                    OWNER
                </a>
            <?php endif; ?>
            <a href="index.php?page=logout" class="bg-red-500/20 border border-red-400 text-red-300 font-semibold py-2 px-4 rounded-md focus:outline-none focus:shadow-outline transition duration-300 ease-in-out hover:scale-105">Cerrar Sesión</a>
        </div>
