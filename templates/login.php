...
<head>
    ...
    <style>
        ...
        .password-toggle {
            ...
            height: 24px;
            z-index: 10;
            opacity: 0.7; /* Añadido: Opacidad para un estilo más sutil */
            transition: opacity 0.2s ease;
        }
        .password-toggle:hover {
            opacity: 1; /* Añadido: Opacidad completa al pasar el mouse */
        }
        .password-input {
...
<body class="bg-gray-900 flex items-center justify-center min-h-screen">
    <div class="bg-white/5 p-8 rounded-xl shadow-lg backdrop-blur-md w-full max-w-md border border-white/10">
        ...
        if (isset($_SESSION['login_error'])) {
            echo "<div class='bg-red-500/10 border border-red-400 text-red-300 p-4 rounded-md mb-4' role='alert'>
